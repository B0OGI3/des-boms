    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background:
            'radial-gradient(circle at 20% 80%, rgba(30, 64, 175, 0.015) 0%, transparent 50%)',
          pointerEvents: 'none',
        }}
      />
        ...
        {statusFilter !== undefined && onStatusChange && (
          <div style={{ minWidth: 140 }}>
            ...
            <Select
              value={statusFilter}
              onChange={value =>
                onStatusChange((value as StatusType | 'ALL') || 'ALL')
              }
              size='md'
              data={statusOptions}
              withCheckIcon={false}
        ...
        {priorityFilter !== undefined && onPriorityChange && (
          <div style={{ minWidth: 140 }}>
            ...
            <Select
              ...
              onChange={value =>
                onPriorityChange((value as PriorityType | 'ALL') || 'ALL')
              }
              size='md'
