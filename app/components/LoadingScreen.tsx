  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: '400px' }}>
        ...
        {pageInitialization && (
          <Text
            style={{ fontSize: '0.85rem', opacity: 0.5, marginTop: '12px' }}
          >
            {Object.values(pageInitialization).filter(Boolean).length} of{' '}
            {Object.keys(pageInitialization).length} components ready
          </Text>
        )}
      </div>
    </div>
