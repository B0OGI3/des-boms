...
export async function GET() {
  try {
    ...
    console.log(
      '[SERVICE-TEST] Step 3: Testing getQuickBooksService function...'
    );
    const { getQuickBooksService } = qbLib;
    console.log(
      '[SERVICE-TEST] getQuickBooksService function found:',
      typeof getQuickBooksService
    );
    ...
    console.log(
      '[SERVICE-TEST] Step 5: Attempting to call getQuickBooksService...'
    );
    const qbService = await getQuickBooksService();
    console.log(
      '[SERVICE-TEST] getQuickBooksService result:',
      qbService ? 'Service created' : 'Service is null'
    );
