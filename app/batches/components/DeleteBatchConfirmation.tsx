      ...
      <Stack gap='md'>
        ...
        {!canDelete && (
          <Alert color='red' title='Cannot Delete'>
            This batch cannot be deleted while it&apos;s in progress. Please
            complete the batch or put it on hold first.
          </Alert>
        )}
        ...
        >
          <Text
            size='sm'
            fw={600}
            style={{ color: '#fca5a5', marginBottom: 8 }}
          >
            This action will:
          </Text>
          <Stack gap={4}>
            ...
            <Text size='sm' style={{ color: '#fca5a5' }}>
              • Remove all routing step confirmations (
              {batch.routingSteps.reduce(
          ...
          <Checkbox
            ...
            label={
              <Text style={{ color: '#f1f5f9' }}>
                I understand this action cannot be undone and want to
